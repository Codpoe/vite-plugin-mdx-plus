...
export const DEMO_MODULE_ID_PREFIX = 'virtual:mdx-pro/demo/';
export const RESOLVED_DEMO_MODULE_ID_PREFIX = '\0' + DEMO_MODULE_ID_PREFIX;

// mdx code demo
export const CODE_DEMO_MODULE_ID_PREFIX = 'virtual:mdx-pro/code-demo/';
...
export const MDX_TS_INFO_RE =
  /<TsInfo\s+src=["'](.*?)["']\s+name=["'](.*?)["']/;
export const TS_INFO_MODULE_ID_PREFIX = 'virtual:mdx-pro/ts-info/';
